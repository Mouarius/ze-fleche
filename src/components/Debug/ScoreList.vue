<template>
    <div class="score-list">
        <table>
            <tr>
                <th v-for="player in globalState.players" :key="player.id">{{ player.name }}</th>
            </tr>
            <tr v-for="(turn, index) in globalState.shotHistory.listOfTurns" :key="index">
                <td v-for="(volley, index) in turn" :key="index">{{ volley }}</td>
            </tr>
        </table>
    </div>
</template>
